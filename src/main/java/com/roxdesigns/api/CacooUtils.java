...
public class CacooUtils {
	...
	private static final String CONSUMER_KEY = "PCjPzVdUeTutkCDXlAAlTG";
	private static final String CONSUMER_SECRET = "DkIMBfJaoEAekKulxWLwGOIlvKTIPpVMwZnYGwuRDq";
